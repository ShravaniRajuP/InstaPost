...
public class DashBoardsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRecyclerView.setLayoutManager(new LinearLayoutManager(DashBoardsActivity.this));
        ...
        mDbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(uploadList.size()>0) {
                    mAdapter=new ImageAdapter(DashBoardsActivity.this,uploadList);
                    mRecyclerView.setAdapter(mAdapter);
                } else {
                    Toast.makeText(DashBoardsActivity.this,
                            "There are no posts available right now" + String.valueOf(uploadList.size()),Toast.LENGTH_LONG).show();
                }
            }
            @Override
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(DashBoardsActivity.this,databaseError.getMessage(),Toast.LENGTH_LONG).show();
            }
