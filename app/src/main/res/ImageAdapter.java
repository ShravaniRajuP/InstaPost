...
public class ImageAdapter extends RecyclerView.Adapter<com.example.instapost.ImageAdapter.ImageViewHolder> {

    private Context mContext;
    private List<com.example.instapost.Upload> mUploads;

    public ImageAdapter(Context context,List<com.example.instapost.Upload> uploads) {
        mContext=context;
        mUploads=uploads;
    }
    ...
    public void onBindViewHolder(ImageViewHolder imageViewHolder, int i) {
        com.example.instapost.Upload uploadCurrent = mUploads.get(i);
